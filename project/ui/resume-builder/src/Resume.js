        ...
        <div className="row">
          ...
          <div className="col-sm-9">   
            ...
            <ul>
              ...
              duties, such as mopping floors and emptying trash cans.</li>
