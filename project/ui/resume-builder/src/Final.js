      ...
      <div className="final-main-container">
          ...
          <div className="col-sm-12">
            <Form action="#" className="resume-form">
                  <FormGroup>
                    ...
                    <Input type="text" pattern="[0-9]{5}" name="location" id="location" placeholder="Enter your zipcode" />
                  </FormGroup>
                  <FormGroup>
        ...
        <div className="row">
          <div className="col-sm-12">
            ...
            <p>We hope to follow up with you regarding your job search and will let you know of upcoming computer
